...
export interface DataVerifierAdapterFixedInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getOracleAddress"
      | "oracle"
...
export interface DataVerifierAdapterFixed extends BaseContract {
  connect(runner?: ContractRunner | null): DataVerifierAdapterFixed;
  waitForDeployment(): Promise<this>;

  interface: DataVerifierAdapterFixedInterface;
